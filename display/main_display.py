...
class MainDisplay(ScalableComponent):
    ...
    def init(self):
        ...
        #
        self.right_block_glyph = self.u5_glyph_registry.get_glyph(
            "IBM.CH", 
        ...
        self.right_cnr_overlay_glyph = self.u5_glyph_registry.get_glyph(
            "IBM.CH", 
            BorderGlyphCodes.BLOCK_GLYPH_IBM_FONT_ID.value
        ).replace_color(
        ...
        corner_maker_func = lambda font_id: self.u5_glyph_registry.get_glyph("IBM.CH", font_id).replace_color(self._color_white, self._color_dark_blue)
        ...
        self.celestial_glyphs = {
            ...
            self.u5_glyph_registry.get_glyph("RUNES.CH", celestial_glyph_code.value).replace_color(
                self._color_white, 
        ...
        # A blank space.
        self.celestial_glyphs[0] = self.u5_glyph_registry.get_glyph("IBM.CH", BorderGlyphCodes.SPACE_IBM_FONT_ID.value)
        ...
        self.right_prompt_overlay = self.u5_glyph_registry.get_glyph("IBM.CH", BorderGlyphCodes.RIGHT_PROMPT_IBM_FONT_ID.value).replace_color(self._color_white, self._color_dark_blue)
        ...
        self.right_prompt = self.u5_glyph_registry.get_glyph("IBM.CH", BorderGlyphCodes.RIGHT_PROMPT_IBM_FONT_ID.value).overlay_with(
    ...
    def draw_wind_direction(self):
        ...
        for cursor, glyph in enumerate(self.u5_glyph_registry.map_string_to_glyphs("IBM.CH", "East  Winds")):
