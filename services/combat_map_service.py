...
class CombatMapService(LoggerMixin):
    ...
    def _get_combat_map_index(self, player_location: GlobalLocation, transport_mode: TransportMode, enemy_npc_agent: NpcAgent):
        ...
        assert not enemy_terrain is None, f"Cannot find enemy_terrain for enemy_terrain_tile_id={enemy_terrain_tile_id}"
        ...
        # party on ship
        elif transport_mode in {TransportMode.SHIP, TransportMode.SAIL}:
